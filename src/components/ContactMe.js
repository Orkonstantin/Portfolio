    ...
    <section id="contact-me" className="contact-me contact section">
      ...
      <div className="container contact__container">
        <Row>
          <Col xs={{ span: 12, order: 1 }} lg={5}>
            <div className="contact__options">
              <article className="contact__option">
                <Row>
                  <Col xs={{ span: 12, order: 1 }} lg={4}></Col>
                  ...
                  <Col xs={{ span: 12, order: 2 }} lg={5}>
                    ...
                    <a href="mailto:kon3101@gmail.com" target="_blank">
                      Send an email
                    </a>
                  </Col>
                </Row>
              ...
              <article className="contact__option">
                <Row>
                  ...
                  <Col xs={{ span: 12, order: 1 }} lg={5}>
                    <h4>WhatsApp</h4>
                    <h5>052-6657676</h5>
                    <a href="https://wa.me/972526657676" target="_blank">
                      Send a message
                    </a>
                  </Col>
                </Row>
          ...
          <Col xs={{ span: 12, order: 2 }} lg={1}></Col>

          <Col
            xs={{ span: 12, order: 3 }}
            lg={6}
            className="contact__options-col"
          >
            <br />
